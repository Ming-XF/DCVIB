"""MNIST 分类 / ImageNet-100 特征分类 / California Housing 回归训练脚本：MLP / CNN 基线及 VIB / SCVIB / DCVIB 变体。
...
def main():
    ...
    parser.add_argument(
        "--task",
        type=str,
        choices=["classification", "regression", "imagenet100"],
        default="classification",
        help="regression uses California Housing; imagenet100 uses pretrained "
        "ResNet50 features (both MLP backbone only)",
    )
