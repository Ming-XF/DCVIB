...
Table~\ref{tab:ablation-ci-epb} for the regression mirrors; the factor ranking and
...
Housing; $95\%$ bootstrap percentile CIs, $B = 10{,}000$, fixed seed, paired
across the shared five seeds at each variant's best validation-selected
configuration; positive values favor the first term).}
