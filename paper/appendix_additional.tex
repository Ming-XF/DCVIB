...
Table~\ref{tab:ablation-ci} reports the paired bootstrap intervals for all
contrasts; the factor ranking and the sign-flip and negative-result patterns are
read in the main text (Section~\ref{sec:ablation}).
