...
configuration under the same two-dimensional tuning grids as the main
comparison, $\beta\times$scale for the GPB-family variants,
$\beta\times$learning rate for the CEB-family variants, and the
learning-rate grid for the prototype-only variants without an IB term
(Table~\ref{tab:ablation}). The complete means are reported in
...
The main comparison sweeps the prior scale jointly with $\beta$
...
only through this collapse boundary, and the validation-selected scale
