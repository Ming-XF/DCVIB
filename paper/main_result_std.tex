...
\begin{table*}[t]
\centering
\caption{Test accuracy (\%) and test $R^2$ with standard deviations over runs: CEB, DVCCA, and our method; same configurations as Table~\ref{tab:main_result}. GPB and OPB-L are separated from the references by the vertical rule.}
...
\hline
Dataset & Backbone & CEB & DVCCA & GPB & OPB-L \\
\hline
