...
\hline
\end{tabular}
\caption{Controlled label-noise floor (mean $\pm$ std over five seeds); max excess is $\max_\beta(\widehat D-\delta_{\rm noise})$, and the last column is the fitted objective minus the explicit comparator objective at $\beta=10$.}
