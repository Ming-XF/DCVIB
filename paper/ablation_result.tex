...
over seeds), with configurations selected by the mean validation metric
(accuracy on MNIST and ImageNet-100). One OPB-FS configuration (ImageNet-100)
diverged during training (free scales grow without penalty at negligible
$\beta$) and is excluded.}
\label{tab:ablation}
\begin{tabular}{l c c}
\hline
