...
equal-width bins and merge any bin containing fewer than $30$ examples; the bin
notation $\bar y_b,\widehat m_b,\widehat D_b,h_b$ and the finite-bin lower bound
Eq.~\eqref{eq:empirical-regression-separation-bound} are defined in the main text.
Figure~\ref{fig:direct-mismatch-housing} shows the two regression sweep panels
deferred from the main text: the mismatch--$\beta$ curves
