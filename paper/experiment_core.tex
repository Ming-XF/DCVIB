...
head. The main comparison is single-dimensional in tuned
...
six-point $\beta$ grid, NCBD and AdaCap use six-value grids of their
own, and GPB's anchor scale $a$ (resp.\ isometric scale $\rho$) is fixed
at $12$ throughout the main comparison. For each method and setting,
