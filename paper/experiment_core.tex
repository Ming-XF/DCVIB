...
CEB, supervised $\beta$-DVCCA, and the external non-IB baselines NCBD (classification
only) and AdaCap (regression only); GPB is OPB on classification rows and EPB on
regression rows, with GPB-L denoting the identical prior and a free head. Full data preprocessing, grids, seeds, and baseline definitions
