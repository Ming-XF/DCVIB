...
so compression stops at the task-information level. OPB with $a=1$ tracks $a=6,12$ until
$\beta=0.5$ and then collapses toward CEB's corner, with $I(Y;Z)$ falling to
$0.35$--$0.74$ nat. The certificate plane
(Fig.~\ref{fig:compression-main}d) reads the same contrast as where each trajectory
ends: CEB and OPB with $a=1$ cross the zero-residual line and $I(Y;Z)$ collapses
with it, whereas $a=6,12$ terminate on it within $\pm0.2$ nat of zero residual at
full task height.
