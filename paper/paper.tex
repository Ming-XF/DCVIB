...
$O(1/\beta)$ upper bound. A separate controlled validation experiment with strictly
deterministic, explicitly realizable labels is specified as a deferred experiment below;
its results are intentionally not included in this version.
