...
guarantee. Together, these results characterize when the declared geometry is
transferred to the learned representation.
...
mean than CEB in all twelve. Geometric diagnostics show that stronger alignment
transfers the declared prior structure to posterior class centers, while
compression sweeps and targeted robustness experiments reveal favorable behavior
in regimes where CEB degrades. Controlled studies and factor-wise ablations further
distinguish the contribution of the geometric bottleneck from that of the readout.
...
separation; and (iv) demonstrating the method across classification and regression
through benchmark comparisons, geometric diagnostics, compression studies,
robustness experiments, and factor-wise ablations.
