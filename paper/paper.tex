...
pairwise distances of their means (Proposition~\ref{prop:geom-blind}). Consequently,
...
We introduce the geometric prior bottleneck (GPB), which places a declared geometry
...
cross-label geometric constraint in CEB; (ii) introducing GPB, with OPB and EPB, to
