...
DCVIB resolves all three mismatches by design: the classifier consumes the deterministic
...
Proposition~\ref{prop:dcvib} below, the side-path regularizer is exactly a CEB bottleneck
...
side-path covariance of DCVIB does (Remark~\ref{rem:limit}). Whether the robustness benefits
