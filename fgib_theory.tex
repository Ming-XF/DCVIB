...
$s = e^{-10}$ during CEB training. If the trained variance settles at an interior value
rather than at the clamp, Proposition~\ref{prop:variance}(iii) is empirically void for
those runs. Until that measurement is made, Part~(iii) should be read as a sharp
hypothesis about the training dynamics, and the force analysis of (i)--(ii) as the only
proved content.
\end{remark}
...
the standing non-atomic assumption (Amjad \& Geiger 2018; Kolchinsky et al.\ 2017), so
